...
df=pd.read_csv('C:/Users/Ankit/OneDrive/Desktop/Ameya Sir/Crop_recommendation.csv')
...
# how the components aare corelated with each other 
#for eg P With N is -0.23
...
plt.colorbar()
plt.xticks(np.arange(n_classes), np.unique(y_test),rotation=90)
